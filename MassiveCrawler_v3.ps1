# ============================================
# MASSIVE CRAWLER v3.0 - FULLY WORKING
...
# ============================================
# FUNCTION: SEND TO DISCORD (DEFINED FIRST!)
# ============================================
...
# ============================================
# FUNCTION: SEND TO TELEGRAM (DEFINED FIRST!)
# ============================================
...
function Generate-Targets {
    ...
    $paths = @("", "/about", "/contact", "/blog", "/news", "/services", "/products")
    $targets = @()
...
# ============================================
# FUNCTION: BACKUP TO GOOGLE DRIVE
# ============================================
...
# Send startup
Send-Discord -Title "🔥 SYSTEM START" -Message "Massive Crawler v3.0 online" -Color "0x00ff00"
Send-Telegram -Message "🔥 <b>SYSTEM START</b>`nMassive Crawler v3.0 online"
